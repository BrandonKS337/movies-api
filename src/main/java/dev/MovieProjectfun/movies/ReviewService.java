...
public class ReviewService {
    ...
    @Autowired
    private MongoTemplate reviewRepository;

    public Review createReview(String reviewBody, String imdbId) { // NOTE: pushes the reviewBody(as a string) through
                                                                   // with the imdbId to the func
        Review review = reviewRepository.insert(new Review(reviewBody)); // NOTE: creates a new review in the
                                                                         // reviewRepository
